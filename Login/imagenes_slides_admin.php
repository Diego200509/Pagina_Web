...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['reset'])) {
        ...
        header("Location: administracion_admin.php?success=1&message=" . urlencode("La imagen de $section_name ha sido restablecida a su valor predeterminado."));
        exit;
    }
    ...
    header("Location: administracion_admin.php?success=$success&message=" . urlencode($message));
    exit;
}
